...
recall limitation of URDF regarding parrallel robot, tricks with closed loop and equality cosntraint, other format that are better suited but did not manage to export. add screenshot and show how to do it for the full robot.