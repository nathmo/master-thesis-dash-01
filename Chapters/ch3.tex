...
Four parameters were each scaled by $\pm50\,\%$ with everything else nominal: leg mass, rotor
inertia, deliverable peak torque and bus voltage (through the no-load speed).
Peak torque is the strongest lever: 50\,\% more raises the bound by about 1\,m/s.
Leg mass is second: 50\,\% less raises the bound by about 0.7\,m/s.
