...
\usepackage[section]{placeins} % keeps a float inside the section that introduces it
...
% Left-aligned fixed-width column. Narrow p{} columns justify badly: the
% interword stretch produces large ragged gaps. L{<width>} sets them ragged
% right instead, which is the convention for narrow table cells.
